...
weak int __syscall_shutdown(int sockfd, int how, int dummy, int dummy2, int dummy3, int dummy4)
{
    REPORT(shutdown);
    return 0;
}
...
// UNIMPLEMENTED(__syscall_shutdown, (int sockfd, int how, int dummy, int dummy2, int dummy3, int dummy4))

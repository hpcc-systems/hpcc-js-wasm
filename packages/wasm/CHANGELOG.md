...
## [2.35.3](https://github.com/hpcc-systems/hpcc-js-wasm/compare/wasm-v2.35.2...wasm-v2.35.3) (2026-09-23)
...
* The following workspace dependencies were updated
  * devDependencies
    * @hpcc-js/wasm-base91 bumped from ^1.16.1 to ^1.16.2
    * @hpcc-js/wasm-duckdb bumped from ^1.20.1 to ^1.20.2
    * @hpcc-js/wasm-expat bumped from ^1.16.1 to ^1.16.2
    * @hpcc-js/wasm-graphviz bumped from ^1.29.1 to ^1.29.2
    * @hpcc-js/wasm-graphviz-cli bumped from ^1.11.2 to ^1.11.3
    * @hpcc-js/wasm-zstd bumped from ^1.16.1 to ^1.16.2

## [2.35.2](https://github.com/hpcc-systems/hpcc-js-wasm/compare/wasm-v2.35.1...wasm-v2.35.2) (2026-09-14)
...
* The following workspace dependencies were updated
  * devDependencies
    * @hpcc-js/wasm-base91 bumped from ^1.16.0 to ^1.16.1
    * @hpcc-js/wasm-duckdb bumped from ^1.20.0 to ^1.20.1
    * @hpcc-js/wasm-expat bumped from ^1.16.0 to ^1.16.1
    * @hpcc-js/wasm-graphviz bumped from ^1.29.0 to ^1.29.1
    * @hpcc-js/wasm-graphviz-cli bumped from ^1.11.1 to ^1.11.2
    * @hpcc-js/wasm-zstd bumped from ^1.16.0 to ^1.16.1

## [2.35.1](https://github.com/hpcc-systems/hpcc-js-wasm/compare/wasm-v2.35.0...wasm-v2.35.1) (2026-09-04)
...
* bump versions (security) ([baece69](https://github.com/hpcc-systems/hpcc-js-wasm/commit/baece69d1bca9bba5cfd49e835362d3b560fe127))
...
* The following workspace dependencies were updated
  * devDependencies
    * @hpcc-js/wasm-base91 bumped from ^1.15.0 to ^1.16.0
    * @hpcc-js/wasm-duckdb bumped from ^1.19.0 to ^1.20.0
    * @hpcc-js/wasm-expat bumped from ^1.15.0 to ^1.16.0
    * @hpcc-js/wasm-graphviz bumped from ^1.28.0 to ^1.29.0
    * @hpcc-js/wasm-graphviz-cli bumped from ^1.11.0 to ^1.11.1
    * @hpcc-js/wasm-zstd bumped from ^1.15.0 to ^1.16.0
...
* The following workspace dependencies were updated
  * devDependencies
    * @hpcc-js/wasm-base91 bumped from ^1.14.7 to ^1.14.8
    * @hpcc-js/wasm-duckdb bumped from ^1.18.7 to ^1.18.8
    * @hpcc-js/wasm-expat bumped from ^1.14.7 to ^1.14.8
    * @hpcc-js/wasm-graphviz bumped from ^1.27.2 to ^1.27.3
    * @hpcc-js/wasm-graphviz-cli bumped from ^1.10.7 to ^1.10.8
    * @hpcc-js/wasm-zstd bumped from ^1.14.2 to ^1.14.3

## [2.34.11](https://github.com/hpcc-systems/hpcc-js-wasm/compare/wasm-v2.34.10...wasm-v2.34.11) (2026-07-21)
...
* The following workspace dependencies were updated
  * devDependencies
    * @hpcc-js/wasm-base91 bumped from ^1.14.6 to ^1.14.7
    * @hpcc-js/wasm-duckdb bumped from ^1.18.6 to ^1.18.7
    * @hpcc-js/wasm-expat bumped from ^1.14.6 to ^1.14.7
    * @hpcc-js/wasm-graphviz bumped from ^1.27.1 to ^1.27.2
    * @hpcc-js/wasm-graphviz-cli bumped from ^1.10.6 to ^1.10.7
    * @hpcc-js/wasm-zstd bumped from ^1.14.1 to ^1.14.2
...
* The following workspace dependencies were updated
  * devDependencies
    * @hpcc-js/wasm-graphviz bumped from ^1.26.0 to ^1.27.0
    * @hpcc-js/wasm-graphviz-cli bumped from ^1.10.4 to ^1.10.5

## [2.34.7](https://github.com/hpcc-systems/hpcc-js-wasm/compare/wasm-v2.34.6...wasm-v2.34.7) (2026-07-15)
...
* The following workspace dependencies were updated
  * devDependencies
    * @hpcc-js/wasm-graphviz bumped from ^1.25.0 to ^1.26.0
    * @hpcc-js/wasm-graphviz-cli bumped from ^1.10.3 to ^1.10.4
...
* The following workspace dependencies were updated
  * devDependencies
    * @hpcc-js/wasm-base91 bumped from ^1.14.2 to ^1.14.3
    * @hpcc-js/wasm-duckdb bumped from ^1.18.2 to ^1.18.3
    * @hpcc-js/wasm-expat bumped from ^1.14.2 to ^1.14.3
    * @hpcc-js/wasm-graphviz bumped from ^1.23.0 to ^1.24.0
    * @hpcc-js/wasm-graphviz-cli bumped from ^1.10.0 to ^1.10.1
    * @hpcc-js/wasm-zstd bumped from ^1.13.2 to ^1.13.3

## [2.34.3](https://github.com/hpcc-systems/hpcc-js-wasm/compare/wasm-v2.34.2...wasm-v2.34.3) (2026-06-18)
...
* The following workspace dependencies were updated
  * devDependencies
    * @hpcc-js/wasm-graphviz bumped from ^1.22.2 to ^1.23.0
    * @hpcc-js/wasm-graphviz-cli bumped from ^1.9.2 to ^1.10.0

## [2.34.2](https://github.com/hpcc-systems/hpcc-js-wasm/compare/wasm-v2.34.1...wasm-v2.34.2) (2026-06-17)


### Bug Fixes

* bump versions ([9750680](https://github.com/hpcc-systems/hpcc-js-wasm/commit/97506802fae898a0dbe3bd00d955143d36501e8a))
...
* The following workspace dependencies were updated
  * devDependencies
    * @hpcc-js/wasm-base91 bumped from ^1.14.1 to ^1.14.2
    * @hpcc-js/wasm-duckdb bumped from ^1.18.1 to ^1.18.2
    * @hpcc-js/wasm-expat bumped from ^1.14.1 to ^1.14.2
    * @hpcc-js/wasm-graphviz bumped from ^1.22.1 to ^1.22.2
    * @hpcc-js/wasm-graphviz-cli bumped from ^1.9.1 to ^1.9.2
    * @hpcc-js/wasm-zstd bumped from ^1.13.1 to ^1.13.2

## [2.34.1](https://github.com/hpcc-systems/hpcc-js-wasm/compare/wasm-v2.34.0...wasm-v2.34.1) (2026-06-15)
...
* The following workspace dependencies were updated
  * devDependencies
    * @hpcc-js/wasm-base91 bumped from ^1.14.0 to ^1.14.1
    * @hpcc-js/wasm-duckdb bumped from ^1.18.0 to ^1.18.1
    * @hpcc-js/wasm-expat bumped from ^1.14.0 to ^1.14.1
    * @hpcc-js/wasm-graphviz bumped from ^1.22.0 to ^1.22.1
    * @hpcc-js/wasm-graphviz-cli bumped from ^1.9.0 to ^1.9.1
    * @hpcc-js/wasm-zstd bumped from ^1.13.0 to ^1.13.1
...
* The following workspace dependencies were updated
  * devDependencies
    * @hpcc-js/wasm-base91 bumped from ^1.13.7 to ^1.14.0
    * @hpcc-js/wasm-duckdb bumped from ^1.17.6 to ^1.18.0
    * @hpcc-js/wasm-expat bumped from ^1.13.6 to ^1.14.0
    * @hpcc-js/wasm-graphviz bumped from ^1.21.7 to ^1.22.0
    * @hpcc-js/wasm-graphviz-cli bumped from ^1.8.13 to ^1.9.0
    * @hpcc-js/wasm-zstd bumped from ^1.12.6 to ^1.13.0

## [2.33.8](https://github.com/hpcc-systems/hpcc-js-wasm/compare/wasm-v2.33.7...wasm-v2.33.8) (2026-05-24)
...
* The following workspace dependencies were updated
  * devDependencies
    * @hpcc-js/wasm-base91 bumped from ^1.13.6 to ^1.13.7
    * @hpcc-js/wasm-duckdb bumped from ^1.17.5 to ^1.17.6
    * @hpcc-js/wasm-expat bumped from ^1.13.5 to ^1.13.6
    * @hpcc-js/wasm-graphviz bumped from ^1.21.6 to ^1.21.7
    * @hpcc-js/wasm-graphviz-cli bumped from ^1.8.12 to ^1.8.13
    * @hpcc-js/wasm-zstd bumped from ^1.12.5 to ^1.12.6
...
* The following workspace dependencies were updated
  * devDependencies
    * @hpcc-js/wasm-graphviz bumped from ^1.21.5 to ^1.21.6
    * @hpcc-js/wasm-graphviz-cli bumped from ^1.8.11 to ^1.8.12

## [2.33.5](https://github.com/hpcc-systems/hpcc-js-wasm/compare/wasm-v2.33.4...wasm-v2.33.5) (2026-05-01)
...
* The following workspace dependencies were updated
  * devDependencies
    * @hpcc-js/wasm-base91 bumped from ^1.13.4 to ^1.13.5
    * @hpcc-js/wasm-duckdb bumped from ^1.17.4 to ^1.17.5
    * @hpcc-js/wasm-expat bumped from ^1.13.4 to ^1.13.5
    * @hpcc-js/wasm-graphviz bumped from ^1.21.4 to ^1.21.5
    * @hpcc-js/wasm-graphviz-cli bumped from ^1.8.10 to ^1.8.11
    * @hpcc-js/wasm-zstd bumped from ^1.12.4 to ^1.12.5

## [2.33.4](https://github.com/hpcc-systems/hpcc-js-wasm/compare/wasm-v2.33.3...wasm-v2.33.4) (2026-04-29)
...
* The following workspace dependencies were updated
  * devDependencies
    * @hpcc-js/wasm-base91 bumped from ^1.13.3 to ^1.13.4
    * @hpcc-js/wasm-duckdb bumped from ^1.17.3 to ^1.17.4
    * @hpcc-js/wasm-expat bumped from ^1.13.3 to ^1.13.4
    * @hpcc-js/wasm-graphviz bumped from ^1.21.3 to ^1.21.4
    * @hpcc-js/wasm-graphviz-cli bumped from ^1.8.9 to ^1.8.10
    * @hpcc-js/wasm-zstd bumped from ^1.12.3 to ^1.12.4

## [2.33.3](https://github.com/hpcc-systems/hpcc-js-wasm/compare/wasm-v2.33.2...wasm-v2.33.3) (2026-03-25)


### Bug Fixes

* update dependencies and fix typos ([2d0ba5e](https://github.com/hpcc-systems/hpcc-js-wasm/commit/2d0ba5e58ae6f6f6e378294601ad202e41da3bd6))
...
* The following workspace dependencies were updated
  * devDependencies
    * @hpcc-js/wasm-base91 bumped from ^1.13.2 to ^1.13.3
    * @hpcc-js/wasm-duckdb bumped from ^1.17.2 to ^1.17.3
    * @hpcc-js/wasm-expat bumped from ^1.13.2 to ^1.13.3
    * @hpcc-js/wasm-graphviz bumped from ^1.21.2 to ^1.21.3
    * @hpcc-js/wasm-graphviz-cli bumped from ^1.8.8 to ^1.8.9
    * @hpcc-js/wasm-zstd bumped from ^1.12.2 to ^1.12.3

## [2.33.2](https://github.com/hpcc-systems/hpcc-js-wasm/compare/wasm-v2.33.1...wasm-v2.33.2) (2026-03-16)


### Bug Fixes

* update dependencies across multiple packages ([8d1659d](https://github.com/hpcc-systems/hpcc-js-wasm/commit/8d1659d30d4271666006956c262423822b241745))
...
* The following workspace dependencies were updated
  * devDependencies
    * @hpcc-js/wasm-base91 bumped from ^1.13.1 to ^1.13.2
    * @hpcc-js/wasm-duckdb bumped from ^1.17.1 to ^1.17.2
    * @hpcc-js/wasm-expat bumped from ^1.13.1 to ^1.13.2
    * @hpcc-js/wasm-graphviz bumped from ^1.21.1 to ^1.21.2
    * @hpcc-js/wasm-graphviz-cli bumped from ^1.8.7 to ^1.8.8
    * @hpcc-js/wasm-zstd bumped from ^1.12.1 to ^1.12.2
...
* The following workspace dependencies were updated
  * devDependencies
    * @hpcc-js/wasm-base91 bumped from ^1.12.0 to ^1.12.1
    * @hpcc-js/wasm-duckdb bumped from ^1.16.0 to ^1.16.1
    * @hpcc-js/wasm-expat bumped from ^1.12.0 to ^1.12.1
    * @hpcc-js/wasm-graphviz bumped from ^1.20.0 to ^1.20.1
    * @hpcc-js/wasm-graphviz-cli bumped from ^1.8.4 to ^1.8.5
    * @hpcc-js/wasm-zstd bumped from ^1.11.0 to ^1.11.1

## [2.32.2](https://github.com/hpcc-systems/hpcc-js-wasm/compare/wasm-v2.32.1...wasm-v2.32.2) (2026-01-14)
...
* The following workspace dependencies were updated
  * devDependencies
    * @hpcc-js/wasm-base91 bumped from ^1.11.0 to ^1.12.0
    * @hpcc-js/wasm-duckdb bumped from ^1.15.0 to ^1.16.0
    * @hpcc-js/wasm-expat bumped from ^1.11.0 to ^1.12.0
    * @hpcc-js/wasm-graphviz bumped from ^1.19.0 to ^1.20.0
    * @hpcc-js/wasm-graphviz-cli bumped from ^1.8.3 to ^1.8.4
    * @hpcc-js/wasm-zstd bumped from ^1.10.0 to ^1.11.0

## [2.32.1](https://github.com/hpcc-systems/hpcc-js-wasm/compare/wasm-v2.32.0...wasm-v2.32.1) (2026-01-13)
...
* The following workspace dependencies were updated
  * devDependencies
    * @hpcc-js/wasm-duckdb bumped from ^1.14.0 to ^1.15.0
...
* The following workspace dependencies were updated
  * devDependencies
    * @hpcc-js/wasm-base91 bumped from ^1.10.0 to ^1.10.1
    * @hpcc-js/wasm-duckdb bumped from ^1.13.0 to ^1.13.1
    * @hpcc-js/wasm-expat bumped from ^1.10.0 to ^1.10.1
    * @hpcc-js/wasm-graphviz bumped from ^1.18.0 to ^1.18.1
    * @hpcc-js/wasm-graphviz-cli bumped from ^1.8.1 to ^1.8.2
    * @hpcc-js/wasm-zstd bumped from ^1.9.0 to ^1.9.1

## [2.31.0](https://github.com/hpcc-systems/hpcc-js-wasm/compare/wasm-v2.30.0...wasm-v2.31.0) (2025-12-29)
...
* The following workspace dependencies were updated
  * devDependencies
    * @hpcc-js/wasm-base91 bumped from ^1.9.0 to ^1.10.0
    * @hpcc-js/wasm-duckdb bumped from ^1.12.0 to ^1.13.0
    * @hpcc-js/wasm-expat bumped from ^1.9.0 to ^1.10.0
    * @hpcc-js/wasm-graphviz bumped from ^1.17.0 to ^1.18.0
    * @hpcc-js/wasm-graphviz-cli bumped from ^1.8.0 to ^1.8.1
    * @hpcc-js/wasm-zstd bumped from ^1.8.0 to ^1.9.0
...
* The following workspace dependencies were updated
  * devDependencies
    * @hpcc-js/wasm-base91 bumped from ^1.8.0 to ^1.9.0
    * @hpcc-js/wasm-duckdb bumped from ^1.11.0 to ^1.12.0
    * @hpcc-js/wasm-expat bumped from ^1.8.0 to ^1.9.0
    * @hpcc-js/wasm-graphviz bumped from ^1.15.0 to ^1.16.0
    * @hpcc-js/wasm-zstd bumped from ^1.7.0 to ^1.8.0

## [2.28.0](https://github.com/hpcc-systems/hpcc-js-wasm/compare/wasm-v2.27.0...wasm-v2.28.0) (2025-10-20)
...
* The following workspace dependencies were updated
  * devDependencies
    * @hpcc-js/wasm-base91 bumped from ^1.7.0 to ^1.8.0
    * @hpcc-js/wasm-duckdb bumped from ^1.10.0 to ^1.11.0
    * @hpcc-js/wasm-expat bumped from ^1.7.0 to ^1.8.0
    * @hpcc-js/wasm-graphviz bumped from ^1.14.0 to ^1.15.0
    * @hpcc-js/wasm-zstd bumped from ^1.6.0 to ^1.7.0

## [2.27.0](https://github.com/hpcc-systems/hpcc-js-wasm/compare/wasm-v2.26.3...wasm-v2.27.0) (2025-10-20)
...
* The following workspace dependencies were updated
  * devDependencies
    * @hpcc-js/wasm-base91 bumped from ^1.6.1 to ^1.7.0
    * @hpcc-js/wasm-duckdb bumped from ^1.9.1 to ^1.10.0
    * @hpcc-js/wasm-expat bumped from ^1.6.1 to ^1.7.0
    * @hpcc-js/wasm-graphviz bumped from ^1.13.0 to ^1.14.0
    * @hpcc-js/wasm-zstd bumped from ^1.5.1 to ^1.6.0
...
* The following workspace dependencies were updated
  * devDependencies
    * @hpcc-js/wasm-base91 bumped from ^1.6.0 to ^1.6.1
    * @hpcc-js/wasm-duckdb bumped from ^1.9.0 to ^1.9.1
    * @hpcc-js/wasm-expat bumped from ^1.6.0 to ^1.6.1
    * @hpcc-js/wasm-graphviz bumped from ^1.12.0 to ^1.12.1
    * @hpcc-js/wasm-zstd bumped from ^1.5.0 to ^1.5.1

## [2.26.1](https://github.com/hpcc-systems/hpcc-js-wasm/compare/wasm-v2.26.0...wasm-v2.26.1) (2025-08-30)
...
* The following workspace dependencies were updated
  * devDependencies
    * @hpcc-js/wasm-graphviz bumped from ^1.11.0 to ^1.12.0

## [2.26.0](https://github.com/hpcc-systems/hpcc-js-wasm/compare/wasm-v2.25.0...wasm-v2.26.0) (2025-08-10)
...
* The following workspace dependencies were updated
  * devDependencies
    * @hpcc-js/wasm-base91 bumped from ^1.5.0 to ^1.6.0
    * @hpcc-js/wasm-duckdb bumped from ^1.8.0 to ^1.9.0
    * @hpcc-js/wasm-expat bumped from ^1.5.0 to ^1.6.0
    * @hpcc-js/wasm-graphviz bumped from ^1.10.0 to ^1.11.0
    * @hpcc-js/wasm-zstd bumped from ^1.4.0 to ^1.5.0

## [2.25.0](https://github.com/hpcc-systems/hpcc-js-wasm/compare/wasm-v2.24.3...wasm-v2.25.0) (2025-07-20)
...
* The following workspace dependencies were updated
  * devDependencies
    * @hpcc-js/wasm-base91 bumped from ^1.4.2 to ^1.5.0
    * @hpcc-js/wasm-duckdb bumped from ^1.7.2 to ^1.8.0
    * @hpcc-js/wasm-expat bumped from ^1.4.2 to ^1.5.0
    * @hpcc-js/wasm-graphviz bumped from ^1.9.2 to ^1.10.0
    * @hpcc-js/wasm-zstd bumped from ^1.3.2 to ^1.4.0
...
* The following workspace dependencies were updated
  * devDependencies
    * @hpcc-js/wasm-base91 bumped from ^1.3.1 to ^1.4.0
    * @hpcc-js/wasm-duckdb bumped from ^1.6.0 to ^1.7.0
    * @hpcc-js/wasm-expat bumped from ^1.3.2 to ^1.4.0
    * @hpcc-js/wasm-graphviz bumped from ^1.8.0 to ^1.9.0
    * @hpcc-js/wasm-zstd bumped from ^1.2.1 to ^1.3.0

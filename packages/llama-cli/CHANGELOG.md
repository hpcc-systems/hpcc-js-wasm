...
## [1.4.3](https://github.com/hpcc-systems/hpcc-js-wasm/compare/wasm-llama-cli-v1.4.2...wasm-llama-cli-v1.4.3) (2026-09-23)
...
* The following workspace dependencies were updated
  * dependencies
    * @hpcc-js/wasm-llama bumped from 1.6.0 to 1.6.1
...
* The following workspace dependencies were updated
  * dependencies
    * @hpcc-js/wasm-llama bumped from 1.4.2 to 1.4.3
...
* The following workspace dependencies were updated
  * dependencies
    * @hpcc-js/wasm-llama bumped from 1.2.0 to 1.3.0

## [1.1.0](https://github.com/hpcc-systems/hpcc-js-wasm/compare/wasm-llama-cli-v1.0.0...wasm-llama-cli-v1.1.0) (2026-07-17)
...
* The following workspace dependencies were updated
  * dependencies
    * @hpcc-js/wasm-llama bumped from 1.1.0 to 1.2.0

## 1.0.0 (2026-07-17)

### Features

* add wasm llama CLI package

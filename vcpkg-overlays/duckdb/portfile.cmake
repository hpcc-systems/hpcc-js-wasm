...
if("excel" IN_LIST FEATURES)
    ...
    file(RENAME "${DUCKDB_EXCEL_SOURCE_PATH}" "${SOURCE_PATH}/extension/excel")
endif()
...
set(EXTENSION_LIST "autocomplete;core-functions;excel;httpfs;icu;json;tpcds;tpch")
set(BUILD_EXTENSIONS "")
foreach(EXT ${EXTENSION_LIST})
    if(${EXT} IN_LIST FEATURES)
        # Special case: convert core-functions to core_functions
        if(${EXT} STREQUAL "core-functions")
            list(APPEND BUILD_EXTENSIONS "core_functions")
        else()
